...
const themeDefinitions: Record<Themes, ThemeDefinition> = {
  [Themes.ORIGINAL]: {
    ...
    properties: {
      ...
      "--color-appliance-label-soft": "#457B9D",
      "--color-appliance-shell-top": "#D7E1EB",
      "--color-appliance-shell-bottom": "#D7E1EB",
      ...
      "--color-appliance-panel-top": "#E4EBF2",
      "--color-appliance-panel-bottom": "#E4EBF2",
      ...
      "--color-appliance-control-panel-top": "#EEF4F8",
      "--color-appliance-control-panel-bottom": "#EEF4F8",
      "--color-appliance-control-panel-border": "#1D35571F",
      "--color-appliance-control-button-top": "#F7FAFC",
      "--color-appliance-control-button-bottom": "#F7FAFC",
      "--color-appliance-control-button-border": "#1D35571F",
      "--color-appliance-control-danger-top": "#F1E7E8",
      "--color-appliance-control-danger-bottom": "#F1E7E8",
  ...
  [Themes.NEGATIVE]: {
    ...
    properties: {
      ...
      "--color-appliance-label-soft": "#495057",
      "--color-appliance-shell-top": "#BDC5CC",
      "--color-appliance-shell-bottom": "#BDC5CC",
      ...
      "--color-appliance-panel-top": "#D0D7DE",
      "--color-appliance-panel-bottom": "#D0D7DE",
      ...
      "--color-appliance-control-panel-top": "#DDE4EA",
      "--color-appliance-control-panel-bottom": "#DDE4EA",
      "--color-appliance-control-panel-border": "#21252922",
      "--color-appliance-control-button-top": "#E8EDF2",
      "--color-appliance-control-button-bottom": "#E8EDF2",
      "--color-appliance-control-button-border": "#21252922",
      "--color-appliance-control-danger-top": "#E3DBDC",
      "--color-appliance-control-danger-bottom": "#E3DBDC",
  ...
  [Themes.NEUTRAL]: {
    ...
    properties: {
      ...
      "--color-appliance-label-soft": "#7368A8",
  ...
  [Themes.POSITIVE]: {
    ...
    properties: {
      ...
      "--color-appliance-label-soft": "#8C2F39",
      "--color-appliance-shell-top": "#E4CFD1",
      "--color-appliance-shell-bottom": "#E4CFD1",
      ...
      "--color-appliance-panel-top": "#EDDCDD",
      "--color-appliance-panel-bottom": "#EDDCDD",
      ...
      "--color-appliance-control-panel-top": "#F3E5E4",
      "--color-appliance-control-panel-bottom": "#F3E5E4",
      "--color-appliance-control-panel-border": "#4612201E",
      "--color-appliance-control-button-top": "#F8ECE9",
      "--color-appliance-control-button-bottom": "#F8ECE9",
      "--color-appliance-control-button-border": "#4612201E",
      "--color-appliance-control-danger-top": "#ECDADB",
      "--color-appliance-control-danger-bottom": "#ECDADB",

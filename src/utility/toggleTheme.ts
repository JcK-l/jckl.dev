...
const themeDefinitions: Record<Themes, ThemeDefinition> = {
  ...
  [Themes.NEUTRAL]: {
    ...
    properties: {
      ...
      "--color-appliance-shell-top": "#F3EFFA",
      "--color-appliance-shell-bottom": "#E4DCF3",
      "--color-appliance-shell-border": "#5E548E33",
      "--color-appliance-shell-pattern":
        "radial-gradient(circle at 16% 14%, rgba(190,149,196,0.22), transparent 24%), radial-gradient(circle at 84% 8%, rgba(224,177,203,0.18), transparent 30%), repeating-linear-gradient(0deg, rgba(94,84,142,0.04) 0px, rgba(94,84,142,0.04) 1px, transparent 1px, transparent 9px), repeating-linear-gradient(90deg, rgba(224,177,203,0.06) 0px, rgba(224,177,203,0.06) 1px, transparent 1px, transparent 14px)",
      "--color-appliance-shell-vent":
        "repeating-linear-gradient(90deg, rgba(35,25,66,0.18) 0px, rgba(35,25,66,0.18) 5px, transparent 5px, transparent 9px)",
      "--color-appliance-panel-top": "#FBF8FF",
      "--color-appliance-panel-bottom": "#EEE7F8",
      "--color-appliance-panel-border": "#5E548E24",
      "--color-appliance-panel-highlight": "#FFFFFF73",
      "--color-appliance-panel-pattern":
        "repeating-radial-gradient(circle at 0 0, rgba(190,149,196,0.08) 0 1px, transparent 1px 14px), repeating-linear-gradient(180deg, rgba(224,177,203,0.08) 0 1px, transparent 1px 6px)",
      ...
      "--color-appliance-control-pattern":
        "repeating-linear-gradient(90deg, rgba(94,84,142,0.08) 0px, rgba(94,84,142,0.08) 1px, transparent 1px, transparent 10px), radial-gradient(circle at 14% 18%, rgba(224,177,203,0.22), transparent 22%)",
      "--color-appliance-control-vent":
        "repeating-linear-gradient(180deg, rgba(35,25,66,0.14) 0px, rgba(35,25,66,0.14) 2px, transparent 2px, transparent 6px)",
      "--color-appliance-control-panel-top": "#FDFBFF",
      "--color-appliance-control-panel-bottom": "#F0E9FA",
      "--color-appliance-control-panel-border": "#5E548E24",
      "--color-appliance-control-button-top": "#FFFFFF",
      "--color-appliance-control-button-bottom": "#F3EDF9",
      "--color-appliance-control-button-border": "#5E548E24",
      "--color-appliance-control-danger-top": "#FFFFFF",
      "--color-appliance-control-danger-bottom": "#F7ECEF",

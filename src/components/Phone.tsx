...
export const Phone = () => {
  ...
  const numberStyle={fill:'var(--color-primary)',fillRule:'evenodd',stroke:'var(--color-primary)',strokeWidth:0.4,strokeLinecap:'round',strokeLinejoin:'round'}
  ...
  return (
    <div className="relative select-none w-11/12 md:w-3/12 2xl:w-3/12 mx-auto shrink-0">
      ...
      <svg
        ...
        ><g
          transform="translate(-29.433558,-45.307568)"><g
            transform="matrix(1.1659726,0,0,1.1659726,-10.345064,-24.332114)"><g
              id="call"
              cursor="pointer"
              onClick={handleCallClick}
              transform="translate(-13.470384,-39.288619)"><circle
                style={{opacity:1,fill:'var(--color-green)',fillOpacity:1,fillRule:'evenodd',strokeWidth:0.184,strokeLinecap:'square',strokeLinejoin:'bevel'}}
                cx="79.073036"
                cy="196.06964"
                r="8.9518633" /><path
              ...
              cursor="pointer"
              transform="translate(-13.470384,-39.288619)"><path
                style={numberBackgroundStyle as React.CSSProperties}
                d="m 100.68592,193.79045 -2.278934,2.27893 2.278934,2.27945 h 3.69538 c 0.23644,0 0.42685,-0.1904 0.42685,-0.42685 v -3.70365 c 0,-0.23644 -0.19041,-0.42684 -0.42685,-0.42684 h -3.69538 z" /><g
                transform="matrix(0.84287451,0,0,0.84287451,16.086077,30.807538)"><path
                  style={{fill:'var(--color-primary)',fillOpacity:1,fillRule:'evenodd',stroke:'var(--color-primary)',strokeWidth:0.7,strokeLinecap:'round',strokeLinejoin:'round',strokeDasharray:'none',strokeOpacity:1}}

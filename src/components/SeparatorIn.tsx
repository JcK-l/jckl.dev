...
export const SeparatorIn = forwardRef<HTMLDivElement, SeparatorInProps>((props, ref) => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <path
          style={{ filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.00)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.0))", fill:"var(--color-fg-color)", strokeLinecap: "round", strokeLinejoin: "miter" }}

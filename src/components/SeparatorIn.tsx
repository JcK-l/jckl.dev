...
export const SeparatorIn = forwardRef<HTMLDivElement, SeparatorInProps>(
  (props, ref) => {
    return (
      <div
        className={`relative ${
          props.middleLayer ? "overflow-visible" : "overflow-hidden"
        }`}
        ref={ref}
      >
        {props.middleLayer ? (
        ...
        <div className="relative overflow-hidden">
          <svg
            className="pointer-events-none relative left-[-1px] z-40 -mb-px -translate-y-px block h-auto w-[calc(100%+2px)] max-w-none"
            version="1.1"

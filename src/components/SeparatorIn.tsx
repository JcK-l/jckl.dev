...
export const SeparatorIn = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <motion.path
          style={{ y: layer3, filter: "drop-shadow(0 10px 25px rgba(35, 25, 66, 0.0))", fill:"var(--color-secondary)" }}
        ...
        />
        <motion.path
          style={{ y: layer2, filter: "drop-shadow(0 10px 25px rgba(35, 25, 66, 0.0))", fill:"var(--color-transition1)"  }}
        ...
        />
        <motion.path
          style={{ y: layer1, filter: "drop-shadow(0 10px 25px rgba(35, 25, 66, 0.0))", fill:"var(--color-transition2)" }}
        ...
        />
        <path
          style={{ filter: "drop-shadow(0 10px 25px rgba(35, 25, 66, 0.0))", fill:"var(--color-white)" }}

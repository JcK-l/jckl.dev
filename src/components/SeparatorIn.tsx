...
export const SeparatorIn = () => {
  ...
  // let layer1 = useTransform(scrollYProgress, [0, 1], ["-10%", "0%"]);
  // let layer2 = useTransform(scrollYProgress, [0, 1], ["-20%", "0%"]);
  // let layer3 = useTransform(scrollYProgress, [0, 1], ["-30%", "0%"]);
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <motion.path
          style={{ y: layer3, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.00)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.0))", fill:"var(--color-secondary)", strokeLinecap: "round", strokeLinejoin: "miter", opacity: 1  }}
     ...
     d="m 960.00001,266.52337 -26.7,-23.8 c -26.6,-23.9 -80,-71.5 -133.3,-85.9 -53.29999,-14.3 -106.69999,4.7 -160,33.7 -53.3,29 -106.69999,68 -160,82.2 -53.29999,14.1 -106.7,3.5 -160,-16.4 -53.29999,-19.8 -106.7,-48.8 -160,-49.5 -53.29999,-0.6 -106.7,27 -133.30001,40.9 l -26.7,13.8 v -213 h 26.7 c 26.60001,0 80.00001,0 133.30001,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 133.3,0 h 26.7 z"
        />
        <motion.path
          style={{ y: layer2, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.00)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.0))", fill:"var(--color-transition1)", strokeLinecap: "round", strokeLinejoin: "miter", opacity: 1   }}
     ...
     d="m 960,160.01465 -26.7,13 c -26.6,13 -80,39 -133.3,59 -53.3,20 -106.7,34 -160,11.5 -53.3,-22.5 -106.7,-81.5 -160,-96.2 -53.3,-14.6 -106.7,15 -160,45.2 -53.3,30.2 -106.7,60.8 -160,59.7 -53.3,-1.2 -106.7,-34.2 -133.3,-50.7 l -26.7,-16.5 v -157 h 26.7 c 26.6,0 80,0 133.3,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 160,0 53.3,0 106.7,0 133.3,0 H 960 Z"
        />
        <motion.path
          style={{ y: layer1, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.00)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.0))", fill:"var(--color-transition2)", strokeLinecap: "round", strokeLinejoin: "miter", opacity: 1  }}

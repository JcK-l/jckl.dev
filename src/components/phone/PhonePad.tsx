...
type PhonePadProps = {
  ...
  bottomRightHighlighted?: boolean;
  className?: string;
...
const numberStyle = {
  fill: "var(--phone-button-icon-fill, var(--color-primary))",
  fillRule: "evenodd",
  stroke: "var(--phone-button-icon-fill, var(--color-primary))",
  strokeWidth: 0.4,
  strokeLinecap: "round",
...
const numberBackgroundStyle = {
  opacity: 1,
  fill: "var(--phone-button-fill, var(--color-white-shade))",
  fillOpacity: 1,
  fillRule: "evenodd",
  strokeWidth: 0.184,
...
const highlightedActionBackgroundStyle = {
  ...numberBackgroundStyle,
  fill: "var(--phone-button-fill, var(--color-green))",
} as const;

const highlightedActionIconStyle = {
  ...numberStyle,
  fill: "var(--phone-button-icon-fill, var(--color-white))",
  stroke: "var(--phone-button-icon-fill, var(--color-white))",
} as const;

const dangerActionBackgroundStyle = {
  ...numberBackgroundStyle,
  fill: "var(--phone-button-fill, var(--color-baloon1))",
} as const;

const dangerActionIconStyle = {
  ...numberStyle,
  fill: "var(--phone-button-icon-fill, var(--color-white))",
  stroke: "var(--phone-button-icon-fill, var(--color-white))",
} as const;
...
export const PhonePad = ({
  ...
  className = "relative mx-auto w-full max-w-[21rem] shrink-0 select-none",
  compactBottom = false,
  display,
  onBottomLeft,
  onBottomRight,
  ...
  const actionBackgroundStyle = bottomRightHighlighted
    ? highlightedActionBackgroundStyle
    : numberBackgroundStyle;
  const actionIconStyle = bottomRightHighlighted
    ? highlightedActionIconStyle
    : numberStyle;
  const bottomLeftBackgroundStyle = bottomLeftDanger
    ? dangerActionBackgroundStyle
    : numberBackgroundStyle;
  const bottomLeftIconStyle = bottomLeftDanger
    ? dangerActionIconStyle
    : numberStyle;
  const viewBoxHeight = compactBottom ? 100 : 125;
  ...
  return (
    <div className={className}>
      ...
      <svg
        className="relative m-4 h-auto w-[calc(100%-2rem)]"
        viewBox={`0 0 74.424544 ${viewBoxHeight}`}
        version="1.1"
        id="svg1"
        ...
        <g transform="translate(-29.433558,-45.307568)">
          <g transform="matrix(1.1659726,0,0,1.1659726,-10.345064,-24.332114)">
            {!showCallButton || !onCall ? null : (
              ...
              >
                <circle
                  style={callButtonStyle as CSSProperties}
                  cx="79.073036"
                  cy="196.06964"
                  r="8.9518633"
                />
            ...
            >
              <circle
                style={numberBackgroundStyle as CSSProperties}
                cx="79.073036"
                cy="107.96717"
                r="8.9518633"
              />
              <path
                style={numberStyle as CSSProperties}
            ...
            >
              <circle
                style={actionBackgroundStyle as CSSProperties}
                cx="101.60757"
                cy="174.04402"
                r="8.9518633"
              />
              <path
                ...
                style={actionIconStyle as CSSProperties}
              />
            </g>
            <g
              className="phone-pad-button phone-pad-digit"
            ...
            <g
              className={`phone-pad-button phone-pad-secondary${
            ...
            >
              <circle
                style={bottomLeftBackgroundStyle as CSSProperties}
                cx="56.538506"
                cy="174.04402"
                r="8.9518633"
              />
              <path
                ...
                style={bottomLeftIconStyle as CSSProperties}
              />
            </g>
          </g>
        </g>

...
export const Face = () => {
  ...
  return (
    <div
      ...
      className="relative z-30 mb-8 w-3/4 h-auto select-none overflow-hidden md:mb-12 md:w-3/4 lg:mb-20 lg:w-8/12 2xl:mb-28 2xl:w-4/12"
    >
      <svg
        viewBox="0 0 900 743"
        version="1.1"
      ...
      >
        <path fill="#231942" d="M 0,0 V 743 H 900 V 0 Z" />
      </svg>
      ...
      >
        <motion.path
          fill="#5e548e"
          style={{ y: layer3, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))" }}
        ...
        />
        <motion.path
          style={{ y: layer2, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))" }}
          // fill="#abb6d4"
          fill="#918ab2"
        ...
        />
        <motion.path
          style={{ y: layer1, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))" }}
          // fill="#d9d1e6"
          fill="#c4c0d6"
...
{/* m 0,0 v 100.00195 643 h 899.99997 v -643 V 0 Z  M 0,0 V 100 743 H 900 V 100 0 Z */ }
      ...
      >
        <path
          style={{ filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))" }}
          fill="#f7f5fb"

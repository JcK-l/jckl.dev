...
export const Face = () => {
  ...
  let layer4 = useTransform(scrollYProgress, [0, 1], ["0vh", "10vh"]);
  ...
  return (
    ...
    >
      ...
      >
        <motion.path
          style={{ y: layer3, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-secondary)", opacity: 1 }}
        ...
        />
        <motion.path
          style={{ y: layer2, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-transition1)", opacity: 1 }}
        ...
        />
        <motion.path
          style={{ y: layer1, filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-transition2)", opacity: 1 }}

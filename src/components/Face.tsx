...
export const Face = () => {
  ...
  return (
    <div
      ref={ref} 
      className="relative z-30 mb-8 w-10/12 h-auto select-none overflow-hidden md:mb-10 sm:w-9/12 md:w-8/12 lg:w-6/12 2xl:w-5/12 desk:w-4/12 desk-l:w-4/12 bg-bgColor"
    >
      <svg
        viewBox="0 0 900 743"
        version="1.1"
      ...
      >
        <motion.path
          style={{ filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-secondary)", opacity: 1 }}
        ...
        />
        <motion.path
          style={{ filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-transition1)", opacity: 1 }}
        ...
        />
        <motion.path
          style={{ filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-transition2)", opacity: 1 }}
      ...
      >
        <path
          style={{ filter: "drop-shadow(0 15px 15px rgba(35, 25, 66, 0.05)) drop-shadow(0 8px 5px rgba(35, 25, 66, 0.1))", fill: "var(--color-fg-color)" }}
